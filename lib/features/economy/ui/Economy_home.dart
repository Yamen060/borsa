...
class EconomyHome extends StatefulWidget {
  ...
  @override
  State<EconomyHome> createState() => _EconomyHomeState();
}

class _EconomyHomeState extends State<EconomyHome> {
          ...
          children: [
            CustomScrollView(
              ...
              slivers: [
                ...
                SliverToBoxAdapter(child: BarWifi(title: 'Economy')),
                SliverToBoxAdapter(child: BarCountryAndWeather()),
