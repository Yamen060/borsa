...
class TextStyles {
  ...
  static TextStyle font20lightwhitereguler = TextStyle(
    fontSize: 20.sp,
  ...
  static TextStyle font11darkbold = TextStyle(
    fontSize: 11.sp,
    fontWeight: FontWeightHelper.bold,
    color: ColorsManager.black,
  );
  ...
  static TextStyle font14lightwhitereguler = TextStyle(
    fontSize: 14.sp,
    fontWeight: FontWeightHelper.regular,
    color: ColorsManager.lightgray,
  );
  static TextStyle font16violetdBold = TextStyle(
    fontSize: 16.sp,
    fontWeight: FontWeightHelper.bold,
